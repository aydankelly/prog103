...
# Finding the hours and days total at the site Nuka_Pass when temperature is
# below -4 and returning cold hours/total days
...
# parameters <- sites, season

coldhours_perday <- function(site, season) {
n_cold_ <- sum(kefj_site == site &
                kefj_season == season &
                kefj_temperature <= -4 &
                kefj_exposure == "air")
